...
const RequestStatus = require('../attributes/requestStatus.js');
...
class Parser {
   ...
   * @return {CommonHeader} The CommonHeader object
   * @static
   * @private
   */
   ...
   * @return {Attribute[]} The Attribute list object
   * @static
   * @private
   */
   ...
   * @param  {String} content The binary string
   * @return {SupportedAttributes} SupportedAttributes object
   * @static
   * @private
   */
   ...
   * @param  {String} content The binary string
   * @return {SupportedPrimitives} SupportedPrimitives object
   * @static
   * @private
   */
   ...
   * @param  {String} content The binary string
   * @return {FloorRequestStatusAtr} FloorRequestStatus object
   * @static
   * @private
   */
   ...
   * @param  {String} content The binary string
   * @return {FloorRequestInformation} FloorRequestInformation object
   * @static
   * @private
   */
   ...
   * @param  {String} content The binary string
   * @return {RequestStatus} RequestStatus object
   * @static
   * @private
   */
   ...
   * @param  {String} content The binary string
   * @return {FloorRequestId} FloorRequestId object
   * @static
   * @private
   */
   ...
   * @return {Message} Object Oriented BFCP Message
