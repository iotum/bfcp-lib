...
const Name = require('../attributes/name.js');
...
class Message {
  /**
   * @constructor
   * @param {CommonHeader} commonHeader The message common header
   * @param {Attribute[]}  attributes   The message list of attributes
   */
   ...
   * @return {Attribute[]} The Attributes List
   * @public
   */
  get attributes() {
   ...
   * @return {Number[]} Binary string representing the BFCP Message
   * @public
   */
  encode() {
