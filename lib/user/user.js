...
class User {
   ...
   * @return {Message} This User last message received by the method
   * 'receiveMessage'
   */
  get currentMessage() {
   ...
   * @return {Number} Current transaction id
   */
   ...
   * @return {Number} This user last wanted floor id received by a
   ...
   * @return {Number} Floor request id
   * @static
   */
